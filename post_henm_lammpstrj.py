...
fluctuation_MD,bo_md,SIG_md,bo_MD,SIG_MD,MD=func_bond_fluctuation.bond_fluctuations(traj2,no_frames_CG,N,flag_identical_bonds,path,system,bond_list)
...
fluctuation_CG,bo_cg,SIG_cg,bo_CG,SIG_CG,CG=func_bond_fluctuation.bond_fluctuations(traj5,no_frames_CG_lmp,N,flag_identical_bonds,path,system,bond_list)

# COMPARISON MD VS CG
func_comparison_MDvsCG.comparison(MD,CG,traj2,traj5,no_of_bonds,N,no_frames_CG,bo_md,bo_cg,fluctuation_MD,fluctuation_CG,path)
